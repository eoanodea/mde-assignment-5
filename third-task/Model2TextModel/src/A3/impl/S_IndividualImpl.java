 ...
 * </p>
 * <ul>
 *   <li>{@link A3.impl.S_IndividualImpl#getIndividual_identifier <em>Individual identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class S_IndividualImpl extends Static_ContentImpl implements S_Individual {
	...
	protected EClass eStaticClass() {
		return A3Package.Literals.SINDIVIDUAL;
	}
	...
	public void setIndividual_identifier(BigInteger newIndividual_identifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, A3Package.SINDIVIDUAL__INDIVIDUAL_IDENTIFIER, oldIndividual_identifier, individual_identifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case A3Package.SINDIVIDUAL__INDIVIDUAL_IDENTIFIER:
