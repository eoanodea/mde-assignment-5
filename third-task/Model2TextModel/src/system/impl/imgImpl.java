 ...
 * </p>
 * <ul>
 *   <li>{@link system.impl.imgImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link system.impl.imgImpl#getAlttext <em>Alttext</em>}</li>
 * </ul>
 *
 * @generated
 */
public class imgImpl extends ContentImpl implements img {
	/**
	...
	protected EClass eStaticClass() {
		return SystemPackage.Literals.IMG;
	}
	...
	public void setUrl(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemPackage.IMG__URL, oldUrl, url));
	}
	...
	public void setAlttext(String newAlttext) {
		...
		alttext = newAlttext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemPackage.IMG__ALTTEXT, oldAlttext, alttext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SystemPackage.IMG__URL:
				return getUrl();
			case SystemPackage.IMG__ALTTEXT:
				return getAlttext();
		}
