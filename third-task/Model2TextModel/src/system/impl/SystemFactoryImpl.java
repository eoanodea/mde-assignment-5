...
public class SystemFactoryImpl extends EFactoryImpl implements SystemFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SystemPackage.NAMED: return createNamed();
			case SystemPackage.SYSTEM: return createSystem();
			case SystemPackage.ENTITY: return createEntity();
			case SystemPackage.FEATURE: return createFeature();
			case SystemPackage.ATTRIBUTE: return createAttribute();
