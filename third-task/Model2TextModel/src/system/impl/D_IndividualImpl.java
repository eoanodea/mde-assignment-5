 ...
 * </p>
 * <ul>
 *   <li>{@link system.impl.D_IndividualImpl#getIndividual_identifier <em>Individual identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class D_IndividualImpl extends D_ContentImpl implements D_Individual {
	...
	protected EClass eStaticClass() {
		return SystemPackage.Literals.DINDIVIDUAL;
	}
	...
	public void setIndividual_identifier(BigInteger newIndividual_identifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemPackage.DINDIVIDUAL__INDIVIDUAL_IDENTIFIER, oldIndividual_identifier, individual_identifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SystemPackage.DINDIVIDUAL__INDIVIDUAL_IDENTIFIER:
