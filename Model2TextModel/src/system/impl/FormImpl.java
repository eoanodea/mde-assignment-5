...
public class FormImpl extends ContentImpl implements Form {
	...
	public void setMethod(MethodType newMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemPackage.FORM__METHOD, oldMethod, method));
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, SystemPackage.FORM__ELEMENTS);
		}
		return elements;
	}
	...
	public Entity getEntity() {
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SystemPackage.FORM__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(Entity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemPackage.FORM__ENTITY, oldEntity, entity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SystemPackage.FORM__ELEMENTS:
				return getElements();
			case SystemPackage.FORM__ENTITY:
