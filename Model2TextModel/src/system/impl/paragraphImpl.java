...
public class ParagraphImpl extends ContentImpl implements Paragraph {
	...
	protected EClass eStaticClass() {
		return SystemPackage.Literals.PARAGRAPH;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemPackage.PARAGRAPH__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SystemPackage.PARAGRAPH__TEXT:
				return getText();
		}
