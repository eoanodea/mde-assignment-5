 ...
 * </p>
 * <ul>
 *   <li>{@link A3.impl.D_IndexImpl#getIndividual <em>Individual</em>}</li>
 *   <li>{@link A3.impl.D_IndexImpl#getIndex_identifier <em>Index identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class D_IndexImpl extends D_ContentImpl implements D_Index {
	...
	protected EClass eStaticClass() {
		return A3Package.Literals.DINDEX;
	}
	...
	public EList<D_Individual> getIndividual() {
		if (individual == null) {
			individual = new EObjectContainmentEList<D_Individual>(D_Individual.class, this, A3Package.DINDEX__INDIVIDUAL);
		}
		return individual;
	}
	...
	public void setIndex_identifier(BigInteger newIndex_identifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, A3Package.DINDEX__INDEX_IDENTIFIER, oldIndex_identifier, index_identifier));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case A3Package.DINDEX__INDIVIDUAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case A3Package.DINDEX__INDEX_IDENTIFIER:
