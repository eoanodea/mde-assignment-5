 ...
 * </p>
 * <ul>
 *   <li>{@link A3.impl.FeatureImpl#isIsPrimaryKey <em>Is Primary Key</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FeatureImpl extends NamedImpl implements Feature {
	/**
	...
	protected EClass eStaticClass() {
		return A3Package.Literals.FEATURE;
	}
	...
	public void setIsPrimaryKey(boolean newIsPrimaryKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, A3Package.FEATURE__IS_PRIMARY_KEY, oldIsPrimaryKey, isPrimaryKey));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case A3Package.FEATURE__IS_PRIMARY_KEY:
