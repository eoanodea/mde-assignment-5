 ...
 * </p>
 * <ul>
 *   <li>{@link A3.impl.S_IndexImpl#getS_individual <em>Sindividual</em>}</li>
 *   <li>{@link A3.impl.S_IndexImpl#getS_Index_identifier <em>SIndex identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class S_IndexImpl extends Static_ContentImpl implements S_Index {
	...
	protected EClass eStaticClass() {
		return A3Package.Literals.SINDEX;
	}
	...
	public EList<S_Individual> getS_individual() {
		if (s_individual == null) {
			s_individual = new EObjectContainmentEList<S_Individual>(S_Individual.class, this, A3Package.SINDEX__SINDIVIDUAL);
		}
		return s_individual;
	}
	...
	public void setS_Index_identifier(String newS_Index_identifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, A3Package.SINDEX__SINDEX_IDENTIFIER, oldS_Index_identifier, s_Index_identifier));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case A3Package.SINDEX__SINDIVIDUAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case A3Package.SINDEX__SINDEX_IDENTIFIER:
