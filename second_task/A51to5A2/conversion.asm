...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchPage_attr():V"/>
		<constant value="__exec__"/>
		<constant value="Page_attr"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyPage_attr(NTransientLink;):V"/>
		<constant value="__matchPage_attr"/>
		...
		<constant value="13:9-15:10"/>
		<constant value="__applyPage_attr"/>
		<constant value="NTransientLink;"/>
		<constant value="NTransientLink;.getSourceElement(S):J"/>
		<constant value="NTransientLink;.getTargetElement(S):J"/>
		<constant value="3"/>
		<constant value="Name"/>
		<constant value="14:21-14:22"/>
		<constant value="14:21-14:27"/>
